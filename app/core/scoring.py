...
a single 0-100 risk score used to make block/pass decisions.
    ...
    Threat-type multipliers        (chunk_indirect_injection highest at 1.6x)
    Source multipliers             (user_query 1.4x vs chunk 1.0x)
...
def compute_score(
    ...
    Returns:
        Tuple of:
            ...
            blocked       (bool)  True when risk_score >= BLOCK_THRESHOLD
